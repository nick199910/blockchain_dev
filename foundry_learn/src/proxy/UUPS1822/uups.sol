...
// 实现合约
contract NumberStorage is LibraryLock, DataLayout, Owned, Proxiable {
...
contract NumberStorageUp is LibraryLock, DataLayout, Owned, Proxiable {
    function constructor1() public {
        totalSupply = 10000;
        require(!initialized, "Initalize finish.");
        initialize();
    ...
    function addNumber(uint256 _number) public delegatedOnly {
        require(
            supplyAmount + _number * 2 < totalSupply,
            "Greater than the maximum supply"
        );
        supplyAmount = supplyAmount + _number * 2;
    }
}
